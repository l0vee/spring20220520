	...
	$(document).ready(function() {
		...
		$("#checkIdButton1").click(function(e) {
			...
			$.ajax({
				...
				type : "get", //단순히 확인
				data : data, //const data 받아서 밑줄 서버로 보냄(data to server)
				...
				error : function() {
					$("#idMessage1").text("아이디 중복 확인 중 문제 발생, 다시 시도해 주세요.");
		...
		$("#checkEmailButton1").click(function(e) {
			...
			$("#checkEmailButton1").attr("disabled", ""); //문제 생기면 disabled
			...
			complete : function() {
				$("#checkEmailButton1").removeAttr("disabled"); //완료되면 disabled 풀어줌
				enableSubmit();
			}
			});
		});

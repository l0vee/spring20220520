...
<script>
	$(document).ready(function() {
		...
		//context path 바뀔 수 있으니까 approot 붙이기
		const listReply = function(){
			...
			$.ajax({
				...
				success:function(list){
					...
					//백틱 = ` string -> el쓰듯이 객체의 property를 그위에 바로 작성할 수 있다.
					//el로 출력되지 않고 자바스크립트로 해석하고 싶으면 역슬래쉬\를 앞에 붙임, 제약이 적어서 따옴표보다 좋다.
